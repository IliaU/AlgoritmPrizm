...
{
    /// <summary>
    /// Для парсинга строк в документе
    /// </summary>
    public class JsonGetDocumentJournal
    {
        // http://ruggmoofffod1.emea.guccigroup.dom/v1/rest/document/606650853000304893/item?cols=*
        ...
        public Int64? package_sequence_number;
        public Int64? lot_number;
        ...
        public bool? udf_float01;
        public bool? udf_float02;
        public bool? udf_float03;
        ...
        public double? delete_discount;
        public string invn_sbs_item_sid;
        public bool? custom_flag;
        ...
        public double? qty_available_for_return;
        public string central_return_commit_state;
        public string inventory_use_quantity_decimals;
        ...
        public double? manual_disc_value;
        ...
        public double? lty_price_in_points_ext;
        public double? lty_piece_of_tbe_points;
        public double? lty_piece_of_tbr_points;
        ...
        public DateTime? eftdata1;
        public DateTime? eftdata2;
        public DateTime? eftdata3;
        public DateTime? eftdata4;
        public DateTime? eftdata5;
        public DateTime? eftdata6;
        public DateTime? eftdata7;
        public DateTime? eftdata8;
        public DateTime? eftdata9;
        public DateTime? eftdata10;
        public DateTime? eftdata11;
        public DateTime? eftdata12;
        public DateTime? eftdata13;
        public DateTime? eftdata14;
        public DateTime? eftdata15;
        public DateTime? eftdata16;
        public DateTime? eftdata17;
        public DateTime? eftdata18;
        public DateTime? eftdata19;
        public DateTime? eftdatabscust;
        public DateTime? eftdatabsmer;
        public int? kit_type;
        ...
        public JsonGetDocumentJournalHrefs hrefs;
    ...
    {
        ""link"": ""/v1/rest/document/606650853000304893/item/606651029000302898"",
        ""sid"": ""606651029000302898"",
        ""created_by"": ""SYSADMIN"",
        ""created_datetime"": ""2021-07-27T14:10:29.000+03:00"",
        ""modified_by"": ""sysadmin"",
        ""modified_datetime"": ""2021-07-27T14:11:17.000+03:00"",
        ""controller_sid"": ""603242764000070002"",
        ""origin_application"": ""RProPrismWeb"",
        ""post_date"": ""2021-07-27T14:10:29.000+03:00"",
        ""row_version"": 899752247,
        ""tenant_sid"": ""603242764000172003"",
        ""document_sid"": ""606650853000304893"",
        ""item_pos"": 2,
        ""quantity"": 1,
        ""original_price"": 915600,
        ""original_tax_amount"": 152600,
        ""price"": 915600,
        ""tax_percent"": 20,
        ""tax_amount"": 152600,
        ""tax2_percent"": 0,
        ...
        ""note1"": ""010290000066650421Jsid2E\""4oh2=D91002a92/1tPzyyagHUbOA+cq0FIp54OZZF6GcVCJhA9W6Mnb7W6LvZEn9r9thrj+HsBFpqyH/zl5Ri6pXxF3HTwjuWeKG=="",
        ""note2"": null,
        ""note3"": null,
        ""note4"": null,
        ""note5"": null,
        ...
        ""dcs_code"": ""120040271"",
        ""vendor_code"": ""GUCCI"",
        ""item_description1"": ""257018E1LAZ"",
        ""item_description2"": ""WOMENS SMLG"",
        ...
        ""invn_sbs_item_sid"": ""601965315000158049"",
        ""custom_flag"": null,
        ""return_reason"": null,
        ""price_lvl"": 1,
        ...
        ""dip_discount_amt"": 0,
        ""dip_price"": 915600,
        ""dip_tax_amount"": 152600,
        ""dip_tax2_amount"": 0,
        ""ref_sale_item_pos"": null,
        ""item_status"": 0,
        ""enhanced_item_pos"": 20000,
        ...
        ""udf_string15"": null,
        ""maxdiscpercent"": 0,
        ""maxaccumdiscpercent"": 0,
        ""override_max_disc_perc"": null,
        ""image_path"": ""inventory\\0000\\0000\\2591\\9149\\"",
        ""promo_gift_item"": 0,
        ...
        ""style_image_path"": ""invn_style\\0667\\7905\\7316\\2477\\"",
        ""internal_item_pos"": 2,
        ""special_order"": false,
        ""dip_price_bdt"": null,
    ...
    {
        ""link"": ""/v1/rest/document/606650853000304893/item/606650864000334895"",
        ""sid"": ""606650864000334895"",
        ""created_by"": ""SYSADMIN"",
        ""created_datetime"": ""2021-07-27T14:07:45.000+03:00"",
        ""modified_by"": ""sysadmin"",
        ""modified_datetime"": ""2021-07-27T14:11:17.000+03:00"",
        ""controller_sid"": ""603242764000070002"",
        ""origin_application"": ""RProPrismWeb"",
        ""post_date"": ""2021-07-27T14:07:44.000+03:00"",
        ""row_version"": 248295690,
        ""tenant_sid"": ""603242764000172003"",
        ""document_sid"": ""606650853000304893"",
        ""item_pos"": 1,
        ""quantity"": 1,
        ...
        ""archived"": false,
        ""total_discount_percent"": 0,
        ""note1"": ""010290000066650421Jsid2E\""4oh2=D91002a92/1tPzrragHUbOA+cq0FIp54OZZF6GcVCJhA9W6Mnb7W6LvZEn9r9thrj+HsBFpqyH/zl5Ri6pXxF3HTwjuWeKG=="",
        ""note2"": null,
        ""note3"": null,
        ""note4"": null,
        ""note5"": null,
            ...
            if (_settings == null)
            {
                ...
                _settings.Error = (sender, args) =>
                {
                    if (object.Equals(args.ErrorContext.Member, "note1") &&
                      args.ErrorContext.OriginalObject.GetType() == typeof(JsonGetDocumentJournal))
                    {
        ...
        public static List<JsonGetDocumentJournal> DeserializeJson(string json)
        {
            return JsonConvert.DeserializeObject<List<JsonGetDocumentJournal>>(json, BLL.JsonGetDocumentJournal.GetSettings());
        }
    }
}
