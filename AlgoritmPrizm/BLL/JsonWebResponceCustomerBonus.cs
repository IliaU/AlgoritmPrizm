...
namespace AlgoritmPrizm.BLL
{
    ...
    /// </summary>
    public class JsonWebResponceCustomerBonus
    {
        ...
        public static string SampleTest = @"
{
            ...
            if (_settings == null)
            {
                ...
                _settings.Error = (sender, args) =>
                {
                    if (object.Equals(args.ErrorContext.Member, "note1") &&
                      args.ErrorContext.OriginalObject.GetType() == typeof(JsonWebResponceCustomerBonus))
                    {
        ...
        /// Сериализация списка
        /// </summary>
        /// <param name="JnWbRespCustBon">Объект JsonWebResponceCustomerBonus</param>
        /// <returns>Строковоке представление объекта</returns>
        public static string SerializeJson(JsonWebResponceCustomerBonus JnWbRespCustBon)
        {
            return JsonConvert.SerializeObject(JnWbRespCustBon);
        }
        ...
        /// <returns>Объект JsonWebResponceCustomerBonus</returns>
        public static JsonWebResponceCustomerBonus DeserializeJson(string json)
        {
            return JsonConvert.DeserializeObject<BLL.JsonWebResponceCustomerBonus>(json, BLL.JsonWebResponceCustomerBonus.GetSettings());
        }
